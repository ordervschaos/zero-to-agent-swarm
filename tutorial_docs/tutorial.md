...
And that's Part 1. We now have a fully functional agent — triggers, loop, tools, memory, container. From here the journey shifts from building an agent to coordinating many of them.

**[Continue to Part 2: A Party of Agents →](./tutorial-part-2.md)** — where we spin up specialists, teach them to delegate, and give them shared memory.
